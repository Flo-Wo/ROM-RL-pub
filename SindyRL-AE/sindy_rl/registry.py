...
from sindy_rl.navier_stokes import NavierStokesControlEnv
...
class NavierStokesWrapper(NavierStokesControlEnv):
    """Wrapper function for the Navier Stokes Equation."""
